...
ciclo_do_while
	...
	| DO LLAVE_A instrucciones_locales LLAVE_C WHILE PARENTESIS_A ciclo_while_condicion PUNTOCOMA {$$ = $1+' '+$2+' '+$3+' '+$4+' '+$5+' '+$6+''+$7+''+$8}
;
...
ciclo_while
	...
	|	WHILE PARENTESIS_A ciclo_while_condicion LLAVE_A instrucciones_locales LLAVE_C {$$ = $1+' '+$2+' '+$3+' '+$4+' '+$5+' '+$6}
;
/*GRAMATICA WHILE-----------------------------------------------------------*/
...
/*GRAMATICA IF ELSE---------------------------------------------------------*/
condicion_if
	: IF PARENTESIS_A ciclo_while_condicion  LLAVE_A instrucciones_locales LLAVE_C {$$ = $1+' '+$2+' '+$3+' '+$4+' '+$5+' '+$6}
	| IF PARENTESIS_A ciclo_while_condicion  LLAVE_A  LLAVE_C {$$ = $1+' '+$2+' '+$3+' '+$4+' '+$5}
	| IF PARENTESIS_A ciclo_while_condicion  LLAVE_A instrucciones_locales LLAVE_C condicion_if_else {$$ = $1+' '+$2+' '+$3+' '+$4+' '+$5+' '+$6+' '+$7}
	| IF PARENTESIS_A ciclo_while_condicion  LLAVE_A LLAVE_C condicion_if_else {$$ = $1+' '+$2+' '+$3+' '+$4+' '+$5+' '+$6}
;
